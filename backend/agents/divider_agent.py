        ...
        try:
            ...
            if not summary_text:
                return self.create_output(
                    data={},
                    success=False,
                    error_message="No summary text provided for division"
                )
            ...
            self.log_info(f"Creating structured paragraphs for {country_1}, {country_2}, relationship: {relationship}")
            ...
            return self.create_output(
                data={},
                success=False,
                error_message=f"Failed to divide content: {str(e)}"
            )
    
    async def _create_structured_paragraphs(self, summary_text: str, country_1: str, country_2: str, relationship: str) -> Dict[str, str]:
        if country_2:
            division_prompt = f"""
...
{{
    ...
    def _fallback_division(self, summary_text: str, country_1: str, country_2: str, relationship: str) -> Dict[str, str]:
