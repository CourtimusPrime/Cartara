        ...
        while True:
            ...
            try:
                ...
                messages = [
                    {
                        "role": "system",
                        "content": "You are an expert of geopolitics and current events.",
                    }
                ]
...
async def chat_endpoint(request: ChatRequest):
    ...
    try:
        ...
        messages = [
            {"role": "system", "content": "You are an expert of geopolitics and current events."}
        ]
...
async def analyze_news(request: NewsAnalysisRequest):
    ...
    try:
        ...
        return NewsAnalysisResponse(
            success=False, error={"type": "server_error", "message": str(e)}
        )
