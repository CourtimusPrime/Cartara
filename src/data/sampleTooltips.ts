...
export const sampleRelationshipData: Record<string, RelationshipTooltipData> = {
  'ukraine-russia': {
    ...
    paragraph:
      'The relationship between Ukraine and Russia remains complex and tense, with ongoing diplomatic efforts by the international community to seek peaceful resolutions. Both countries have historical and cultural ties, but current circumstances have strained relations significantly. International observers continue to monitor the situation closely.',
    lastUpdated: '2024-01-15T00:00:00Z',
  ...
  'china-united states': {
    ...
    paragraph:
      'US-China relations involve a complex mix of cooperation and competition across economic, technological, and diplomatic spheres. Both nations maintain significant trade relationships while navigating strategic differences. Recent diplomatic engagements have focused on climate cooperation, trade discussions, and regional security concerns.',
    lastUpdated: '2024-01-15T00:00:00Z',
    sources: ['Reuters', 'Financial Times', 'Associated Press'],
  },
  'united states-china': {
